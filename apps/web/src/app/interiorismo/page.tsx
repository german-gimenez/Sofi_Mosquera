...
import { createDb, projects, desc, eq } from "@sofi/db";
...
export const metadata: Metadata = {
  title: "Interiorismo",
  description:
    "Proyectos integrales de interiorismo residencial y comercial. Diseño que refleja la esencia de quién habita cada espacio.",
};
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16">
        <SectionReveal>
          ...
          <p className="font-body font-light text-brand-negro-suave mt-4 max-w-2xl text-lg leading-relaxed">
            Diseñamos cada espacio desde una visión integral, combinando
