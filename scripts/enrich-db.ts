...
async function enrichArtworks() {
  ...
  const updates = [
    { slug: "el-rey", technique: "Acrílico sobre lienzo", widthCm: 120, heightCm: 90, priceArs: 450000, year: 2024 },
    { slug: "isla-gris", technique: "Acrílico sobre lienzo", widthCm: 100, heightCm: 80, priceArs: 380000, year: 2024 },
    { slug: "mountains", technique: "Acrílico sobre lienzo", widthCm: 120, heightCm: 100, priceArs: 480000, year: 2024 },
    { slug: "nacimiento", technique: "Técnica mixta sobre lienzo", widthCm: 110, heightCm: 90, priceArs: 420000, year: 2024 },
    { slug: "muri", technique: "Acrílico sobre lienzo", widthCm: 90, heightCm: 70, priceArs: 320000, year: 2023 },
    { slug: "musica", technique: "Acrílico sobre lienzo", widthCm: 100, heightCm: 80, priceArs: 380000, year: 2023 },
    { slug: "intercambio", technique: "Acrílico sobre lienzo", widthCm: 80, heightCm: 60, priceArs: 280000, year: 2023 },
    { slug: "triptico-mapa", technique: "Acrílico sobre lienzo (tríptico)", widthCm: 180, heightCm: 90, priceArs: 650000, year: 2024 },
  ];
  ...
  const newArtworks = [
    { slug: "serie-2026-01", title: "Nueva Línea 2026 — I", series: "Nueva Línea 2026", technique: "Acrílico sobre lienzo", widthCm: 120, heightCm: 100, priceArs: 520000, year: 2026, status: "disponible", featured: true },
    { slug: "serie-2026-02", title: "Nueva Línea 2026 — II", series: "Nueva Línea 2026", technique: "Acrílico sobre lienzo", widthCm: 120, heightCm: 100, priceArs: 520000, year: 2026, status: "disponible", featured: true },
    { slug: "expresionista-01", title: "Expresionista I", series: "Expresionistas", technique: "Óleo sobre lienzo", widthCm: 100, heightCm: 80, priceArs: 420000, year: 2025, status: "disponible", featured: false },
    { slug: "expresionista-02", title: "Expresionista II", series: "Expresionistas", technique: "Óleo sobre lienzo", widthCm: 90, heightCm: 70, priceArs: 360000, year: 2025, status: "disponible", featured: false },
  ];
...
async function enrichProjects() {
  ...
  const updates = [
    ...
    { slug: "penthouse", tags: ["residencial", "penthouse", "dormitorio", "vista panorámica"] },
    ...
    { slug: "produccion-casa-laura-y-lucas", tags: ["residencial", "vivienda familiar", "producción editorial"] },
  ...
  const newFurniture = [
    {
      ...
      description: "Mesa de comedor a medida en madera de roble macizo, con terminación natural y patas de hierro forjado. Dimensiones y medidas personalizables según el proyecto.",
    ...
    },
    {
      ...
      description: "Mueble bajo de living a medida, con cajones y puertas para integrar TV y almacenamiento. Combinación de madera y herrajes de diseño.",
    ...
    },
    {
      ...
      description: "Biblioteca modular con estantes flotantes de madera y estructura metálica. Ideal para ambientes de living o estudio.",
      materials: "Madera de petiribí, acero negro mate",
    ...
    },
    {
      ...
      description: "Mesa ratona con tapa de piedra natural (mármol o travertino) y base de hierro con terminación al agua.",
      materials: "Mármol, hierro al agua",
...
async function enrichSettings() {
  ...
  const about = {
    ...
    heading: "Diseñadora de autor en Mendoza",
    body: "Apasionada del arte en todas sus formas, creo que detrás de cada obra hay un alma que se expresa, y sucede lo mismo con los espacios. A través del interiorismo, diseño y me conecto con las personas para adaptar sus espacios a la vida que sueñan vivir.",
    mission: "Diseño espacios que reflejan la esencia de quien los habita, integrando interiorismo, arte y muebles a medida con excelencia en cada terminación.",
    values: [
      { title: "Calidad", description: "Diseños a medida de gran impacto en tu calidad de vida." },
      { title: "Empatía", description: "Para que los espacios sean un reflejo de quien los habita." },
      { title: "Sustentabilidad", description: "Desde los materiales hasta la línea de producción." },
    ],
  };
  ...
  const aboutPhotosDefault = JSON.stringify([
    "sofi-mosquera/about/sofia-01",
    "sofi-mosquera/about/sofia-02",
    "sofi-mosquera/about/sofia-03",
  ]);
  ...
  await sql`INSERT INTO settings (key, value, updated_at) VALUES ('about_photos', ${aboutPhotosDefault}::jsonb, NOW()) ON CONFLICT (key) DO NOTHING`;
  console.log("  updated hero, about, contact, about_photos");
}
